...
Then use the agent tool with subagent type Explore to walk the codebase. Don't follow rigid heuristics — explore organically and note where you experience friction:
