...
8. Then use `to-spec` to synthesize the discussion and save the spec to `docs/specs/YYYY-MM-DD-<feature-slug>.md`.
9. Do not implement or create an implementation plan unless the user explicitly asks.
