...
Fan out independent discovery and research tickets in parallel. Every delegation states scope, context, constraints, expected output, and verification. Work directly only for primary-level judgment, cross-cutting decisions, final integration, or failed delegation.
